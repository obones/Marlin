 ...
 */
#define HOTEND_OVERSHOOT 15   // (°C) Forbid temperatures over MAXTEMP - OVERSHOOT // GR necessario per i 300 gradi
 ...
 */
#define PIDTEMP           // See the PID Tuning Guide at https://reprap.org/wiki/PID_Tuning  // GR
//#define MPCTEMP         // ** EXPERIMENTAL ** See https://marlinfw.org/docs/features/model_predictive_control.html  // MPC solo per termistore Inox
 ...
 */
  ...
  #define MPC_EDIT_MENU                             // Add MPC editing to the "Advanced Settings" menu. (~1.3K bytes of flash)	// GR MPC menu
  #define MPC_AUTOTUNE_MENU                         // Add MPC auto-tuning to the "Advanced Settings" menu. (~350 bytes of flash)	// GR MPC autotune menu
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 8.5f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.070f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.046f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
...
#define X_MIN_POS 0
#define Y_MIN_POS -2  // GR -2 mm la posizione Y 
#define Z_MIN_POS 0
